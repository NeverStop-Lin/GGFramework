...
namespace Game.UI
{
    ...
    public partial class GameUI : UGUIBaseUIBehaviour
    {
        ...
        protected override void BindComponents()
        {
            ...
            _startButton = FindComponent<Button>("GameUI/Panel/@Button_Start");
            _settingsButton = FindComponent<Button>("GameUI/Panel/@Button_Settings");
            _titleText = FindComponent<Text>("GameUI/Panel/@Text_Title");
        }
