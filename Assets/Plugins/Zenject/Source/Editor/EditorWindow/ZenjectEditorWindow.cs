...
namespace Zenject
{
    public abstract class ZenjectEditorWindow : EditorWindow
    {
        ...
        protected virtual void Initialize()
        {
            ...
            _container = new DiContainer(new[]
            {
        ...
        public virtual void OnGUI()
        {
            if (_fatalError != null)
            {
                ...
                GUI.Label(
                    new Rect(Screen.width / 2 - labelWidth / 2, Screen.height / 3 - labelHeight / 2,
                ...
                if (GUI.Button(
                    new Rect(Screen.width / 2 - buttonWidth / 2 + offset.x,
                        Screen.height / 3 - buttonHeight / 2 + offset.y, buttonWidth, buttonHeight),
                    "Reload"))
                {
                    ExecuteFullReload();
                }
