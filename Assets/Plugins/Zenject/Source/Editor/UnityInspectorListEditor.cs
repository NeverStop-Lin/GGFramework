    ...
    public abstract class UnityInspectorListEditor : Editor
    {
        ...
        public virtual void OnEnable()
        {
            ...
            foreach (var info in infos)
            {
                ...
                ReorderableList installersList = new ReorderableList(serializedObject,
                    installersProperty, true, true, true, true);
                ...
                installersList.drawElementCallback += (rect, index, active, focused) =>
                {
                    rect.width -= 40;
                    rect.x += 20;
                    EditorGUI.PropertyField(rect, installersProperty.GetArrayElementAtIndex(index),
