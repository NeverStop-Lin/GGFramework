    ...
    public class SceneDecoratorContextEditor : ContextEditor
    {
        ...
        protected override string[] PropertyNames
        {
            get
            {
                ...
                {
                    "_lateInstallers", "_lateInstallerPrefabs", "_lateScriptableObjectInstallers"
                }).ToArray();
            }
        }
        ...
        protected override string[] PropertyDisplayNames
        {
            get
            {
                ...
                {
                    "Late Installers", "Late Prefab Installers", "Late Scriptable Object Installers"
                }).ToArray();
            }
        }
        ...
        public override void OnEnable()
        {
            ...
            _decoratedContractNameProperty
                = serializedObject.FindProperty("_decoratedContractName");
        }
