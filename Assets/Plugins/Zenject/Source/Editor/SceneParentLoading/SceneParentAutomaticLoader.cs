...
namespace Zenject.Internal
{
    ...
    public static class SceneParentAutomaticLoader
    {
        ...
        )
        {
            ...
            decoratedSceneInfo = LoadDefaultSceneForContract(sceneInfo, decoratedContractName,
                defaultContractsMap);
        ...
        )
        {
            foreach (var parentContractName in sceneInfo.SceneContext.ParentContractNames)
            {
                ...
                parentInfo = LoadDefaultSceneForContract(sceneInfo, parentContractName,
                    defaultContractsMap);
        ...
        )
        {
            ...
            {
                throw new ZenjectException(
                    "Error while attempting to load contracts for scene '{0}'".Fmt(sceneInfo.Scene
                        .name), e);
            }
        ...
        {
            var configs
                = Resources.LoadAll<DefaultSceneContractConfig>(DefaultSceneContractConfig
                    .ResourcePath);
