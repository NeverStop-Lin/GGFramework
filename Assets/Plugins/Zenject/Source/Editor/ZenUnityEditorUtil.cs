...
namespace Zenject.Internal
{
    public static class ZenUnityEditorUtil
    {
        ...
        public static SceneContext GetSceneContextForScene(Scene scene)
        {
            ...
            Assert.IsNotNull(sceneContext, "Could not find scene context for scene '{0}'",
                scene.name);
        ...
        public static SceneDecoratorContext GetDecoratorContextForScene(Scene scene)
        {
            ...
            Assert.IsNotNull(decoratorContext, "Could not find decorator context for scene '{0}'",
                scene.name);
        ...
        {
            return Path.Combine(Path.Combine(Path.GetFullPath(Application.dataPath), ".."),
                assetPath);
        }
        ...
        public static List<string> GetSelectedAssetPathsInProjectsTab()
        {
            ...
            UnityEngine.Object[] selectedAssets = Selection.GetFiltered(typeof(UnityEngine.Object),
