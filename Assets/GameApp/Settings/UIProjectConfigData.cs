        ...
        static partial void GetUIConfigsExternal(ref List<UIInstanceConfig> configs)
        {
            configs = new List<UIInstanceConfig>
            {
                new UIInstanceConfig
                {
                    ...
                    LogicScriptPath = "Assets/GameApp/Scripts/UI/GameHUD.cs"
                },
                new UIInstanceConfig
                {
                    UIName = "InitialLoadingUI",
                    ResourcePath = "UI\\InitialLoadingUI",
                    LayerName = "Top",
                    CacheStrategy = UICacheStrategy.NeverCache,
                    Preload = false,
                    InstanceStrategy = UIInstanceStrategy.Singleton,
                    LogicScriptPath = "Assets/GameApp/Scripts/UI/InitialLoadingUI.cs"
                },
            };
        }
    }
